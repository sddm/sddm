...
namespace SDDM {
    ...
    const QString &Utils::authInfoString(Auth::Info info)
    {
    ...
    const QString &Utils::authErrorString(Auth::Error err)
    {
        ...
        switch(err) {
            case Auth::ERROR_PAM_CONV:
                return authEnumError[0]; break;
            case Auth::ERROR_AUTHENTICATION:
                return authEnumError[1]; break;
            case Auth::ERROR_INTERNAL:
                return authEnumError[2]; break;
            case Auth::ERROR_UNKNOWN:
                return authEnumError[3]; break;
            case Auth::ERROR_NONE:
